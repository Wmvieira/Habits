/*
  ...
  - You are about to drop the column `habity_id` on the `day_habits` table. All the data in the column will be lost.
...
CREATE TABLE "new_day_habits" (
    ...
    CONSTRAINT "day_habits_habit_id_fkey" FOREIGN KEY ("habit_id") REFERENCES "days" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
